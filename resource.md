...
### Wet-lab
1.  [**SOP: Propagation of Kc167**](https://www.zhengmzlab.com/files/SOP_for_HCT116_cell.pdf): a detailed protocol and quality control results of RDD library construction.
...
1.  [**scAIR-pipeline**](https://github.com/ZhengmzLab/scAIR-pipeline): a specifically pipeline for scAIR (single cell - ATACseq + Interactome + RNAseq) methods.
